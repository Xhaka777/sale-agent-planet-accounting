...
public class TotalTargetActivity extends Activity implements OnChartValueSelectedListener {
...
//        binding.totalt
    ...
    public void setLocale(String localeName){
        if(!localeName.equals(currentLang)){
            ...
            Toast.makeText(TotalTargetActivity.this, R.string.language_already_selected, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void getBaseTarget() {
        apiService.getTotalTarget(new BaseTargetPost(preferences.getUserId(), preferences.getToken(),
                TargetActivity.MONTH, TargetActivity.YEAR))
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(response -> {
                    setupView(response.getData().getTotalSaleTarget());
                }, throwable -> {
...
//        rightAxis.setGranularityEnabled(false);
    ...
    private SpannableString generateCenterSpannableText() {
        ...
        SpannableString s = new SpannableString("Targeti Total\n developed by KAF");
