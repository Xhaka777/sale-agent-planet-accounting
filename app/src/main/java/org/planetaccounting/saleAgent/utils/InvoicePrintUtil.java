...
public class InvoicePrintUtil {
    ...
    public InvoicePrintUtil(InvoicePost minvoicePost, WebView mwebView, Context ctx, Client client, PrintManager printManager) {
...
//        <img src="adriatik.png" class="logo_head no_invoice_hide"/>
        ...
        line = line.replace("document_type", "Featurë");
    ...
    String createArticleHtml(InvoicePost invoicePost, Client client) {
        ...
        for (int i = 0; i < invoicePost.getItems().size(); i++) {
            ...
            finalCode = finalCode + "<tr >" +
                    ...
                    "<td class=\"text-right\">" + invoicePost.getItems().get(i).getPrice_base() + "</td>" +
